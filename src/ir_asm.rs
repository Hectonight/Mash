...
pub fn instr_to_asm(instr: &IRInst) -> String {
    match instr {
        ...
        | Mov(dest @ Mem(_), source @ Reg(_)) => format!("mov {}, {}", dest, source),
        Mov(dest @ Mem(_), source @ Imm(_)) => format!("mov qword {}, {}", dest, source),
        ...
        Sal(dest @ Reg(_), source @ Reg(reg!(CL))) | Sal(dest @ Reg(_), source @ Imm(_)) => {
            format!("sal {}, {}", dest, source)
        }
        Sal(dest @ Mem(_), source @ Reg(reg!(CL))) | Sal(dest @ Mem(_), source @ Imm(_)) => {
            format!("sal qword {}, {}", dest, source)
        }

        Shl(dest @ Reg(_), source @ Reg(reg!(CL))) | Shl(dest @ Reg(_), source @ Imm(_)) => {
            format!("shl {}, {}", dest, source)
        }
        Shl(dest @ Mem(_), source @ Reg(reg!(CL))) | Shl(dest @ Mem(_), source @ Imm(_)) => {
            format!("shl qword {}, {}", dest, source)
        }

        Sar(dest @ Reg(_), source @ Reg(reg!(CL))) | Sar(dest @ Reg(_), source @ Imm(_)) => {
            format!("sar {}, {}", dest, source)
        }
        Sar(dest @ Mem(_), source @ Reg(reg!(CL))) | Sar(dest @ Mem(_), source @ Imm(_)) => {
            format!("sar qword {}, {}", dest, source)
        }

        Shr(dest @ Reg(_), source @ Reg(reg!(CL))) | Shr(dest @ Reg(_), source @ Imm(_)) => {
            format!("shr {}, {}", dest, source)
        }
        Shr(dest @ Mem(_), source @ Reg(reg!(CL))) | Shr(dest @ Mem(_), source @ Imm(_)) => {
        ...
        | Test(dest @ Mem(_), source @ Reg(_)) => format!("test {}, {}", dest, source),
        Test(dest @ Mem(_), source @ Imm(_)) => format!("test qword {}, {}", dest, source),
        ...
        | And(dest @ Mem(_), source @ Reg(_)) => format!("and {}, {}", dest, source),
        And(dest @ Mem(_), source @ Imm(_)) => format!("and qword {}, {}", dest, source),
        ...
        | Or(dest @ Mem(_), source @ Reg(_)) => format!("or {}, {}", dest, source),
        Or(dest @ Mem(_), source @ Imm(_)) => format!("or qword {}, {}", dest, source),
        ...
        | Xor(dest @ Mem(_), source @ Reg(_)) => format!("xor {}, {}", dest, source),
        Xor(dest @ Mem(_), source @ Imm(_)) => format!("xor qword {}, {}", dest, source),
        ...
        | Add(dest @ Mem(_), source @ Reg(_)) => format!("add {}, {}", dest, source),
        Add(dest @ Mem(_), source @ Imm(_)) => format!("add qword {}, {}", dest, source),
        ...
        | Sub(dest @ Mem(_), source @ Reg(_)) => format!("sub {}, {}", dest, source),
        Sub(dest @ Mem(_), source @ Imm(_)) => format!("sub qword {}, {}", dest, source),
        ...
        | Cmp(dest @ Mem(_), source @ Reg(_)) => format!("cmp {}, {}", dest, source),
        Cmp(dest @ Mem(_), source @ Imm(_)) => format!("cmp qword {}, {}", dest, source),

        Pop(dest @ Reg(R16(_))) | Pop(dest @ Reg(R64(_))) => format!("pop {}", dest),
        Pop(Mem(dest)) => format!("pop qword {}", dest),

        Push(dest @ Reg(R16(_))) | Push(dest @ Reg(R64(_))) | Push(dest @ Imm(_)) => {
            format!("push {}", dest)
        }
        Push(Mem(dest)) => format!("push qword {}", dest),

        Inc(dest @ Reg(_)) | Inc(dest @ Mem(_)) => format!("inc {}", dest),

        Dec(dest @ Reg(_)) | Dec(dest @ Mem(_)) => format!("dec {}", dest),
        ...
        IMul(Reg(dest), None, None) => format!("mul {}", dest),
        ...
        IMul(Mem(dest), None, None) => format!("mul qword {}", dest),
        ...
        | Lea(dest @ R64(_), source @ Mem(_)) => format!("lea {}, {}", dest, source),
        ...
        | Jmp(dest @ Reg(R16(_)))
        | Jmp(dest @ Reg(R32(_)))
        | Jmp(dest @ Reg(R64(_))) => format!("jmp {}", dest),
        ...
        | CMove(dest @ R64(_), source @ Mem(_)) => format!("cmove {}, {}", dest, source),
        ...
        | CMovne(dest @ R64(_), source @ Mem(_)) => format!("cmovne {}, {}", dest, source),
        ...
        | CMovl(dest @ R64(_), source @ Mem(_)) => format!("cmovl {}, {}", dest, source),
        ...
        | CMovle(dest @ R64(_), source @ Mem(_)) => format!("cmovle {}, {}", dest, source),
        ...
        | CMovg(dest @ R64(_), source @ Mem(_)) => format!("cmovg {}, {}", dest, source),
        ...
        | CMovge(dest @ R64(_), source @ Mem(_)) => format!("cmovge {}, {}", dest, source),
        ...
        | CMova(dest @ R64(_), source @ Mem(_)) => format!("cmova {}, {}", dest, source),
        ...
        | CMovae(dest @ R64(_), source @ Mem(_)) => format!("cmovae {}, {}", dest, source),
        ...
        | CMovb(dest @ R64(_), source @ Mem(_)) => format!("cmovb {}, {}", dest, source),
        ...
        | CMovbe(dest @ R64(_), source @ Mem(_)) => format!("cmovbe {}, {}", dest, source),
        ...
        | CMovc(dest @ R64(_), source @ Mem(_)) => format!("cmovc {}, {}", dest, source),
        ...
        | CMovz(dest @ R64(_), source @ Mem(_)) => format!("cmovz {}, {}", dest, source),
        ...
        | CMovze(dest @ R64(_), source @ Mem(_)) => format!("cmovze {}, {}", dest, source),
        ...
        | CMovnl(dest @ R64(_), source @ Mem(_)) => format!("cmovnl {}, {}", dest, source),
        ...
        | CMovng(dest @ R64(_), source @ Mem(_)) => format!("cmovng {}, {}", dest, source),
        ...
        | CMovnge(dest @ R64(_), source @ Mem(_)) => format!("cmovnge {}, {}", dest, source),
        ...
        | CMovnle(dest @ R64(_), source @ Mem(_)) => format!("cmovnle {}, {}", dest, source),
        ...
        | CMovna(dest @ R64(_), source @ Mem(_)) => format!("cmovna {}, {}", dest, source),
        ...
        | CMovnb(dest @ R64(_), source @ Mem(_)) => format!("cmovnb {}, {}", dest, source),
        ...
        | CMovnae(dest @ R64(_), source @ Mem(_)) => format!("cmovnae {}, {}", dest, source),
        ...
        | CMovnbe(dest @ R64(_), source @ Mem(_)) => format!("cmovnbe {}, {}", dest, source),
        ...
        | CMovo(dest @ R64(_), source @ Mem(_)) => format!("cmovo {}, {}", dest, source),
        ...
        | CMovp(dest @ R64(_), source @ Mem(_)) => format!("cmovp {}, {}", dest, source),
        ...
        | CMovno(dest @ R64(_), source @ Mem(_)) => format!("cmovno {}, {}", dest, source),
        ...
        | CMovnp(dest @ R64(_), source @ Mem(_)) => format!("cmovnp {}, {}", dest, source),
        ...
        | CMovs(dest @ R64(_), source @ Mem(_)) => format!("cmovs {}, {}", dest, source),
        ...
        | CMovpo(dest @ R64(_), source @ Mem(_)) => format!("cmovpo {}, {}", dest, source),
        ...
        | CMovpe(dest @ R64(_), source @ Mem(_)) => format!("cmovpe {}, {}", dest, source),
        ...
        | CMovns(dest @ R64(_), source @ Mem(_)) => format!("cmovns {}, {}", dest, source),
        ...
        | CMovnz(dest @ R64(_), source @ Mem(_)) => format!("cmovnz {}, {}", dest, source),
